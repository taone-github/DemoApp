		...
		function tmL(tmN,tmO){
			...
			this.tmV=function(){
				...
				function tmR(tmW){
					...
					if(!tmX)return;
					if(!tmX.innerHTML){
						var tmK=[];for(var i=0;i<this.tmK.length;i++)tmK[i]=this.tmK[i].tmM();
