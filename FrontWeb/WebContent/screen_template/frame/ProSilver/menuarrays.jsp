	...
	if (hAuthenMenu.containsKey(menuM.getMenuID()) || (ias3Mode == false)) {
		...
		if (ias3Mode == false) {
			...
			if("PAGE".equals(menuM.getMenuType())){		
				...
				String permChkStr3 = (String)request.getSession().getAttribute("permChkStr3");
				if(menuM.getMenuAction()!=null) menuM.setMenuAction(menuM.getMenuAction() + "&permChkStr1=" + menuM.getMenuID() + "&permChkStr2=" + userName + "&permChkStr3aa" + permChkStr3);
