...
<a href="#" class="logo">
  	...
  	<span class="logo-mini"><!--<b>A</b>LT--><img src="screen_template/frame/Responsive2016/images/oneweblogo2.svg"></span>
 	<!-- logo for regular state and mobile devices -->
  	<span class="logo-lg"><img src="screen_template/frame/Responsive2016/images/oneweblogo.svg"><!--<b>Process</b>Designer--></span>
</a>
...
<!--                  <span class="label label-warning">10</span> -->
                ...
                <ul class="dropdown-menu shadow3">
                 ...
                 <li class="footer"><a href="/MasterWeb/FrontController?action=loadTodolist&userName=<%=request.getRemoteUser() %>" target="mainPage">View all</a></li>
...
<!--             </li> -->
            ...
            <li class="dropdown user user-menu">
                ...
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                  ...
                  <img src="screen_template/frame/scripts/dist/img/user2-160x160.jpg" class="user-image" alt="User Image">
