...
function checkFileFormat(){
	...
	if(vfileName!=''){
		...
		if(extension!='' && !(extension.toLowerCase()=='xls')){
			alert("Extension of file must be xls only.");
			form.reset();
		}  
	} 
}	
...
<div>
<form name="AddImageForm" method="post" enctype="multipart/form-data" action="ImportExcelServlet">
