...
if(!"".equalsIgnoreCase(currentTab) && null != currentTab){	  	 
	...
	System.out.println("vTabModuleMs===>"+vTabModuleMs);  
...
$(document).ready( function() {
	try{
		initPicObj<%=moduleM.getModuleID()%>("<%=tabModuleM.getRelationType().toLowerCase()%>");
	}catch(e){}
...
<%
		...
		System.out.println("moduleM.getModuleID() : "+moduleM.getModuleID()+ " | moduleActionM -> " + moduleActionM);
