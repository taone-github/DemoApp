...
<% com.avalant.display.CompositeModuleDisplayJSON mod = new com.avalant.display.CompositeModuleDisplayJSON(request); %>
$(document).ready(function() {
	var jsonData = <%=mod.compositeModuleJSON()%>;
	compositeModule(jsonData,'<%=request.getParameter("comId")%>',<%=mdoDis.isGrid()%>);
});
