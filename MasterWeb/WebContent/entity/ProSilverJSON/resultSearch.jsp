...
<div class="swapResultDIV">
	<button class="swapBtn" type="button" onclick="swapResult()">
		<img src="/MasterWeb/theme/ToDoList/images/icon/thumnals.png" />
	</button>
</div>
<div class="tablearea" id="resultDIV" >
<%
...
%>
	<jsp:include flush="true" page="search/resultTemplate.jsp"/>
<%
}else{
%>
