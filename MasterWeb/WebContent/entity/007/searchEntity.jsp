...
<div id="subNavigator" class="child_Nav">
	<ul>
		...
		<li class="current blur" id="<%=form.getEntityM().getEntityID()%>Li">
		<a href="#"><span><%=MasterUtil.displayEntityName(form.getEntityM(),request)%></span></a>
		</li>
...
%>
	    ...
	    <td class="td_OneRelation <%=MasterForm.getModuleM().getModuleID()%>_<%=prmModuleFieldM.getFieldID()%>_label <%=MasterForm.getModuleM().getModuleID()%>_<%=prmModuleFieldM.getFieldID()%>_input" <%=lastRowColSpan %> >
