...
<% 
	...
	com.master.util.Log4jUtil.log("MasterForm==>"+MasterForm);
	if (MasterForm == null) {
...
<%
	...
	com.master.util.Log4jUtil.log("vShowColumns==>"+vShowColumns);
...
<%
	...
	com.master.util.Log4jUtil.log("totalWidth==>"+totalWidth);

	for (int i= 0;i < vShowColumns.size();i++) {
		ModuleFieldM  moduleM = (ModuleFieldM)vShowColumns.get(i);
		com.master.util.Log4jUtil.log("moduleM==>"+moduleM);	
%>      
...
<%} %>
<% 
com.master.util.Log4jUtil.log("vShowSearchRecs -> " + vShowSearchRecs.size());
...
<% 
	com.master.util.Log4jUtil.log(" LIST MANY stringBlock :"+stringBlock);
	com.master.util.Log4jUtil.log(" LIST MANY keyForSearch :"+keyForSearch);
