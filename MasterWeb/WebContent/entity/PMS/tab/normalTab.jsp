...
<div class="bgactionbar">
	<div class="bgaction2">
		<div class="actionplace" id="UNDER_<%=tabDisplay.getEntityID()%>Bt">
			<%
				buttonTag = com.master.button.DisplayButton.displayDivButton(request,tabDisplay.getEntityID(),tabDisplay.getButtonAction()+"_UNDER");
			%>
			<%=buttonTag%>
		</div>
		<div class="bgaction1"></div>
