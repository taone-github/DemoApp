...
<table width="80%" border="0" cellpadding="0" cellspacing="0" align="center"> 
	...
	<tr>
		<td valign="top">
			<table width="100%" cellpadding="1" cellspacing="0" align="center" border = '1' class = "manyRowDiv">
				<thead>
				<tr  height="19">      
					<th width = "25%"  align="center" height="19" class="TableHeaderList">Change Topic</th> 
					<th width = "20%"  align="center" height="19" class="TableHeaderList">Old Value</th> 
					<th width = "20%"  align="center" height="19"  class="TableHeaderList">New Value</th> 
				...
				<%
					String oldValue = DisplayFormatUtil.displayHTML(historyDataM.getOldValue());
					String newValue = DisplayFormatUtil.displayHTML(historyDataM.getNewValue());
					if(oldValue == ""){oldValue = "&nbsp";}
					if(newValue == ""){newValue = "&nbsp";}
					
				%>
					<td align="center" class="bu2"><%=DisplayFormatUtil.displayHTML(historyDataM.getFieldName())%></td>
					<td align="center" class="bu2"><%=oldValue%></td>
					<td align="center" class="bu2"><%=newValue%></td>
