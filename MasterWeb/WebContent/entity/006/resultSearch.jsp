...
<TABLE width="100%" border="0" cellpadding="0" cellspacing="0">
	<tr>
		<td colspan="4" valign="top">
			<div align="center"  id ="manyRowDivID" class="manyRowDiv" style="height:400px">
...
%>      
							<th align="center" class="TableHeaderList <%=moduleM.getModuleID()%>_<%=moduleM.getFieldID()%>_header">
...
int startRow = (MasterForm.getVolumePerPage()*MasterForm.getPage())-MasterForm.getVolumePerPage();
...
%>
							<td width ="4%" align ="center"  height="19" class="bu2" ><%=(startRow+i+1)%></td>
<% 
...
%>
							<td  align="<%=align%>" class="bu2 <%=moduleM.getModuleID()%>_<%=moduleM.getFieldID()%>_col" <%=onclickEvent%> ><div id="<%=moduleM.getFieldID()%>_<%=i%>"><a href="#" <%=onclickEvent%>><%=strSearchResult%></a></div></td>
<%	
		} else {
%>
							<td align="<%=align%>" class="bu2 <%=moduleM.getModuleID()%>_<%=moduleM.getFieldID()%>_col" <%=onclickEvent%> ><div id="<%=moduleM.getFieldID()%>_<%=i%>"><a href="#" <%=onclickEvent%>>&nbsp;</a></div></td>
<%	
		}
	}	
%>
