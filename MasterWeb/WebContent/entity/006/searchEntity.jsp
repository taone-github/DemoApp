...
<script language="javascript" src="<%=request.getContextPath()%>/manual/js/session/sessiontimeout.js"></script>
...
<%
	...
	if (moduleActionM != null){
		if(null != moduleActionM.getSearchFilePath() && !"".equals(moduleActionM.getSearchFilePath())) {
		...
		} else if (null != moduleActionM.getFilePath() && !"".equals(moduleActionM.getFilePath())) {
			...
			System.out.println("moduleActionM.isInnerIncludeFlag() -> " + moduleActionM.isInnerIncludeFlag());
