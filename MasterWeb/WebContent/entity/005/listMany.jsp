...
%>  
    <td align="right" class="text <%=MasterForm.getModuleM().getModuleID()%>_<%=prmModuleFieldM.getFieldID()%>_label" ><%=MasterUtil.displayFieldName(prmModuleFieldM,request)%></td>       
    <td align="left" class="text <%=MasterForm.getModuleM().getModuleID()%>_<%=prmModuleFieldM.getFieldID()%>_input"  ><%=tagShow%></td>
