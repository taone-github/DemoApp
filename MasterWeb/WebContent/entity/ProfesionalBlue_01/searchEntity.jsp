...
<table width="100%" border="0" cellpadding="0" cellspacing="0" align="center"  class="sidebar8"  >
	<tr>
		<td class="sidebar9">
			<table width="100%" border="0" cellSpacing="0" cellPadding="0">	
				<tbody>
					...
					<TD>
						...
						<TBODY>
						<TR>
						<TD class=text-header-detail><%=form.getEntityM().getEntityName()%></TD>
						</TR>
						</TBODY>
						</TABLE>
					</TD>
...
%>
		...
		<div class="componentDiv" id="<%=htmlComponentNamed %>" nowrap>
				<%=tagShow%>
			</div>
		</td>
<%
...
%>
 ...
 <style>
 #accountInfo_NAME_LabelField {
 	background-color: red;
 	width : 10;
 }
 #accountInfo_NAME_InputField {
 	background-color: red;
 	width : 10;
 }
 .td_OneRelation {
...
<%=MasterUtil.generateCustomStyle(null, form, MasterForm, MasterForm.getProcessMode()) %>
 ...
 <table width="100%" border="0" cellpadding="1" cellspacing="0" align="center">
	<tr>
		<td> 
			<div id="<%=entityID %>_resultSearchContainer" class="resultSearchContainer" style="float: center;">
<%
