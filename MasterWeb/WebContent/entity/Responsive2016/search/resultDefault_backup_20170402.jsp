...
%>
			<div class="text-center seart col-md-2 col-sm-4 col-xs-12" style="padding-top: 10px;">
...
%>		
		<div align="<%=align%>" <%=onclickEvent %>  class="seart col-md-2 col-sm-4 col-xs-12 <%=moduleM.getModuleID()%>_<%=moduleM.getFieldID()%>_col"  <%=(align!=null&&!"".equals(align) ? "style=\"padding-bottom: 10px;padding-top: 10px;text-align: "+align+"\"" : "") %>>
<!-- 	    header in row -->
<!-- 	    <div class="orderColumnDiv " id = "orderColumnDivID" > -->
<!-- 		<table width="100%" border="0" cellpadding="0" cellspacing="0"> -->
<!-- 			<tr> -->
...
<!-- 		</div> -->
<!-- 	    End header in row -->
		<div <%=onclickEvent %> class ="showElement" id="<%=moduleM.getFieldID()%>_<%=i%>"  <%=(align!=null&&!"".equals(align) ? "style=\"margin-right:15px ;padding-left: 3px; " : "") %> ><%=tagStr%></div> <!--  text-align: "+align2+"\" -->
		</div>					 
<%			
	}	
%>
