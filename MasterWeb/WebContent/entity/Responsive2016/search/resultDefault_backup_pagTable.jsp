...
// 										if (entityM.isShowRadio()) objType="radio";
									 %>
<%-- 								<span class="text-center"><input type = "checkbox" name = "checkRow" value ="<%=keyForSearch%>" onclick="changeCheckBox(this)"></span> --%>
<%-- 								<span class="text-center" width ="3%"><input type = "checkbox" name = "<%=entityM%>deleteRow" value ="<%=i%>" data-size="large"></span> --%>
								      <% 
								 
// 								    }
								    %>
<!-- 						   </div> -->
			<div class="text-center seart col-md-2 col-sm-2 col-xs-12" style="padding-top: 50px;padding-bottom: 50px; border-right: 1px solid #ddd;">
			<div class="col-md-2">
			<span class="text-center" width ="3%"><input type = "checkbox" name = "<%=entityM%>deleteRow" value ="<%=i%>" data-size="large"></span>
			</div>
			
			<div class="col-md-10"  style="display: flex;">
			<div class="text-header"  style="padding-left: 10px;">
			<%=MessageResourceUtil.getTextDescription(request, "WORDING.ITEM_NO") %>
			</div>
			<div class="showElement"  style="/*padding-top: 3px;  padding-right:25px */">
			<%=(i+1)%>
			</div>
			</div>
			</div>
...
<% 
	...
	for (int j= 0;j < vShowColumns.size();j++) {
		...
		*/
		...
		String align = "center";//center Old
		String align2 = "left";
...
%>		
		...
		<div align="<%=align%>"  class="seart col-md-2 col-sm-4 col-xs-12 <%=moduleM.getModuleID()%>_<%=moduleM.getFieldID()%>_col"  <%=(align!=null&&!"".equals(align) ? "style=\"padding-bottom: 10px;padding-top: 10px;text-align: "+align2+"\"" : "") %>>
<!-- 	    header in row -->
<!-- 	    <div class="orderColumnDiv " id = "orderColumnDivID" > -->
<!-- 		<table width="100%" border="0" cellpadding="0" cellspacing="0"> -->
<!-- 			<tr> -->
<!-- 				<td> -->
				<div class="row oderdiv">
    			<div class="text-header-search"><%=MasterUtil.displayFieldName(moduleM,request)%></div>
<!--     			</td> -->
...
<!-- 		</div> -->
<!-- 	    End header in row -->
		<div class ="showElement" id="<%=moduleM.getFieldID()%>_<%=i%>"  <%=(align!=null&&!"".equals(align) ? "style=\"margin-right:15px ;padding-left: 3px;text-align: "+align+"\"" : "") %> ><%=tagStr%></div> 
		</div>	
