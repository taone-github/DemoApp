...
<% 
	...
	String sourceAttached =	MasterUtil.getSourceAttachmentResponsive(MasterForm.getModuleM(),vStoreActions,vModelMs,hAllObj,MasterForm.getProcessMode());										 		
%>
<div class="td_AttachmentFile">
	<%=sourceAttached%>
</div>
