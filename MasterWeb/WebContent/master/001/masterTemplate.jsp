...
<table class = "tableForm" align = "center"  width="80%" cellpadding="0" cellspacing="0" border="0">
...
%>
			<td valign="top" align="right"><NOBR>&nbsp;<%=MasterUtil.displayFieldName(prmModuleFieldM,request)%><%=MasterUtil.displayManDate(prmModuleFieldM)%>&nbsp;</NOBR></td>
			<td width="5px">&nbsp;</td>
			<td valign="top" align="left">&nbsp;<%=tagShow%>&nbsp;</td>
<%
