...
Calendar.prototype.show = function() {
	...
	if (thaiFlag == "Y") {
		this.wwriteA(this.gMonthName + " " + (parseInt(this.gYear)+543));
	} else {
...
Calendar.prototype.format_data = function(p_day) {
	...
	var vY2 ="";	
	if (thaiFlag == "Y") {
		vY4 = new String(parseInt(this.gYear)+ 543);
		vY2 = (new String(parseInt(this.gYear)+543)).substr(2,2) ;
	} else {
